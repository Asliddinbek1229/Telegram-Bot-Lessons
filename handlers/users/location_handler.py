...
from keyboards.default.color_keyboard import kb
from utils.misc.get_dictanse import choose_shortest
from loader import dp


@dp.callback_query_handler(text="mylocation")
async def show_contact_keys(call: CallbackQuery):
    await call.message.answer(text="Lokasiya yuboring:", reply_markup=kb)
